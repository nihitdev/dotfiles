...
This repository includes two prompt configurations:
...
Both require a [Nerd Font](https://www.nerdfonts.com/) for their icons to render correctly.
...
- Prompts: Oh My Posh and Starship
